  ...
  return (
    <div>
      <div className='text-center sm:text-left text-2xl sm:text-3xl py-6 sm:py-8'>
        ...
        <p className='text-center sm:text-left text-xs sm:text-sm md:text-base text-gray-600 max-w-full sm:max-w-[65%] px-2 sm:px-0'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 sm:gap-4 gap-y-5 sm:gap-y-6'>
        {menuList.map((item) => (
          ...
          >
            ...
            />
            <h3 className='text-xs sm:text-lg text-center font-semibold mt-2'>
              {item.name}
            </h3>
          </button>
        ))}
